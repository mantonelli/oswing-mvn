 ...
 * </p>
 * <p>
 * Description: radio button whose text is translated according to
...
public class RadioButtonControl extends JRadioButton implements InputControl {
	...
	public final void setToolTipText(String toolTipText) {
		...
		if (!Beans.isDesignTime())
			super.setToolTipText(ClientSettings.getInstance().getResources()
	...
	public final void setEnabled(boolean enabled) {
		...
		if (enabled && isRequired() && ClientSettings.PAINT_BG_MANDATORY_FIELD) {
			super.setForeground(UIManager.getColor("TextField.foreground"));
			super.setBackground(ClientSettings.REQUIRED_FIELD_BG_COLOR);
		} else {
			super.setForeground(UIManager.getColor("TextField.foreground"));
	 ...
	 * 
	 * @param selectedValue
	 *            value that will be setted by the radio button when it's
	 *            selected
	 */
	...
	public final void setText(String text) {
		if (Beans.isDesignTime())
			...
			super.setText(ClientSettings.getInstance().getResources()
					.getResource(text));
	}
